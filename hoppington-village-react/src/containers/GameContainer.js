     ...
     return (
      <div className={this.state.class}>
        <div className="pet-display">
          ...
          <PetContainer scroll={this.state.scroll} beingDragged={this.state.beingDragged} endOfDrag={this.state.endOfDrag} animals={this.state.animals} auth={this.props.auth} handleHop={this.handleHop}currentUser={this.props.currentUser}/>
        </div>
      </div>
    )
  }
